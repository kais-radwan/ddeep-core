...
var SCANNER = require('./policies/scanner2'); // scan and process policies
...
var get = function (peer, msg, graph, storage) {
    return __awaiter(this, void 0, void 0, function () {
        var soul, prop, ack;
        return __generator(this, function (_a) {
            soul = msg === null || msg === void 0 ? void 0 : msg.get["#"];
            prop = msg === null || msg === void 0 ? void 0 : msg.get["."];
            if (prop)
                soul = "".concat(soul, "+.").concat(prop);
            try {
                ack = RFG(msg.get, graph);
                if (ack) {
                    SCANNER(soul, "get", ack, function () {
                        if (peer)
                            listen(soul, peer);
                        PE.emit('get', peer, {
