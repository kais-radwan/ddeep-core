...
function getAIClasses(data) {
    return __awaiter(this, void 0, void 0, function () {
        var hf, classes, val, key, keyValue, hfInstance, res, classification, value, label, score, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    hfInstance = new inference_1.HfInference(hf);
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, hfInstance.textClassification({
                ...
                case 2:
                    ...
                    if (!res || typeof res !== "object")
                        throw new Error("Smart policy processing error");
                    ...
                    for (classification in res) {
                        ...
                        score = value === null || value === void 0 ? void 0 : value.score;
